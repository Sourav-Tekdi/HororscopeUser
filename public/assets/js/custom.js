$(document).ready(function(){
  ...
  $('.as_customer_nav').slick({
    ...
    // menu toggle
    $(document).on('click', '.as_toggle', function () {
      $(this).parent().toggleClass('menu_open');
      // Add this condition to handle the closing behavior
      if ($(this).parent().hasClass('menu_open')) {
          $(this).find('img').attr('src', '/assets/images/svg/close.svg');
      } else {
          $(this).find('img').attr('src', '/assets/images/svg/menu.svg');
      }
  });
  
  $(document).on('click', '.as_toggle_close', function () {
      // Close the menu when the close button is clicked
      $(this).closest('.as_menu_wrapper').removeClass('menu_open');
      $(this).closest('.as_menu_wrapper').find('.as_toggle img').attr('src', '/assets/images/svg/menu.svg');
  });
